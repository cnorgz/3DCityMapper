...
- `docs/ai/review_packet_bundle_phase11_code.md` for Phase 11 code scope

## Docs Layout Note
- Canonical documentation lives under `/docs`.
- Root-level similarly named files are stubs pointing to `/docs`.
- These duplicates are intentional for discoverability and backward links.

## Packaging Policy
Use markdown uploads. No zip is required for standard SeniorDev review.
